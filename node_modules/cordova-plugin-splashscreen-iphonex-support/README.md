...
## Credits
This plugin is based upon the official plugin, but adds support for the iPhone X, which the official plugin doesn't include at the moment.
All the credits go to the official [cordova-plugin-splashscreen plugin](https://www.npmjs.com/package/cordova-plugin-splashscreen).
